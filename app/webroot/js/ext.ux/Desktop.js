...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    shortcutTpl: [
        '<tpl for=".">',
        //'<tpl if="(xindex - 1) &lt; (xcount / 2)">',//possible multi-colimn sollution:  http://jsfiddle.net/6ZUej/1/
    ...
    initComponent: function () {
        ...
        if (wallpaper) {
            me.setWallpaper(wallpaper, me.wallpaperLayout);
        }
    },
    ...
    onShortcutItemClick: function (dataView, record) {
        var me = this, module = me.app.getModule(record.data.module),
            win = module && me.app.runModule(module, record.data.params);
    ...
    onWindowClose: function(win) {
        ...
        if(win.module) {
            win.module.windows.remove(win);
            if(win.module.windows.getCount() == 0 && win.module.stopOnLastWindowClose === true) {
                win.module.stop();
                delete win.module;
            }
        }
    ...
    setWallpaper: function (wallpaper, layout) {
        this.wallpaper.setWallpaper(wallpaper, layout);
        return this;
    },
    ...
    createWindow: function(config, cls) {
        ...
        if(cls && !ExtUtils.isSubclassOf(cls, Ext.ux.desktop.Window)) {
            Ext.Error.raise('cls argument must be a constructor subclassing from Ext.ux.desktop.Window');
        }

        cls = cls || Ext.ux.desktop.Window;
        
        cfg.doNotProcess = true;
        cfg.desktop = me;
    ...
    attachWindow: function(win) {
        ...
        //add to module's own windows collection
        if(win.module) {
            win.module.windows.add(win);
        }
    ...
    addToTray: function(cmp) {
        var me = this;
        me.taskbar.tray.insert(0, cmp);
    },
    removeFromTray: function(cmp) {
        var me = this;
        me.taskbar.tray.remove(cmp);
    }
});
