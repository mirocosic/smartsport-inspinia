...
Ext.define('Ext.ux.desktop.App', {
    ...
    getStartConfig: function () {
        ...
        Ext.each(me.modules, function (module) {
            ...
            if (launcher) {
                launcher.handler = launcher.handler || Ext.bind(me.runModule, me, [module, launcher.params]);
    ...
    runModule: function(module, params) {
        
        params = params || {};
        
        var found = this.getModule(module);
        if(found) {
            found.run(this, params);
        } else {
            var newModule = new module();
            newModule.run(this, params);
        }
    },
    ...
    getModule : function(search) {
    	var ms = this.modules;
        for (var i = 0, len = ms.length; i < len; i++) {
            var m = ms[i];
            if (m.id == search || m === search || (Ext.isFunction(search) && (m instanceof search))) {
                return m;
            }
        }
        return null;
